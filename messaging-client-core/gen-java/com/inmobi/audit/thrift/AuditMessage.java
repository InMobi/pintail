...
public class AuditMessage implements TBase<AuditMessage, AuditMessage._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField FILESMOVED_FIELD_DESC = new TField("filesmoved", TType.MAP, (short)10);
  ...
  public Map<String,String> filesmoved;
  ...
  public enum _Fields implements TFieldIdEnum {
    ...
    TAGS((short)9, "tags"),
    FILESMOVED((short)10, "filesmoved");
  ...
  static {
    ...
    tmpMap.put(_Fields.TAGS, new FieldMetaData("tags", TFieldRequirementType.DEFAULT, 
        new MapMetaData(TType.MAP, 
            new FieldValueMetaData(TType.STRING), 
            new FieldValueMetaData(TType.STRING))));
    tmpMap.put(_Fields.FILESMOVED, new FieldMetaData("filesmoved", TFieldRequirementType.DEFAULT, 
        new MapMetaData(TType.MAP, 
            new FieldValueMetaData(TType.STRING), 
            new FieldValueMetaData(TType.STRING))));
  ...
  public AuditMessage(AuditMessage other) {
    ...
    if (other.isSetFilesmoved()) {
      Map<String,String> __this__filesmoved = new HashMap<String,String>();
      for (Map.Entry<String, String> other_element : other.filesmoved.entrySet()) {

        String other_element_key = other_element.getKey();
        String other_element_value = other_element.getValue();

        String __this__filesmoved_copy_key = other_element_key;

        String __this__filesmoved_copy_value = other_element_value;

        __this__filesmoved.put(__this__filesmoved_copy_key, __this__filesmoved_copy_value);
      }
      this.filesmoved = __this__filesmoved;
    }
  }
  ...
  public int getFilesmovedSize() {
    return (this.filesmoved == null) ? 0 : this.filesmoved.size();
  }

  public void putToFilesmoved(String key, String val) {
    if (this.filesmoved == null) {
      this.filesmoved = new HashMap<String,String>();
    }
    this.filesmoved.put(key, val);
  }

  public Map<String,String> getFilesmoved() {
    return this.filesmoved;
  }

  public AuditMessage setFilesmoved(Map<String,String> filesmoved) {
    this.filesmoved = filesmoved;
    return this;
  }

  public void unsetFilesmoved() {
    this.filesmoved = null;
  }

  /** Returns true if field filesmoved is set (has been asigned a value) and false otherwise */
  public boolean isSetFilesmoved() {
    return this.filesmoved != null;
  }

  public void setFilesmovedIsSet(boolean value) {
    if (!value) {
      this.filesmoved = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FILESMOVED:
      if (value == null) {
        ...
        setFilesmoved((Map<String,String>)value);
      }
      break;
  ...
  public boolean equals(AuditMessage that) {
    ...
    boolean this_present_filesmoved = true && this.isSetFilesmoved();
    boolean that_present_filesmoved = true && that.isSetFilesmoved();
    if (this_present_filesmoved || that_present_filesmoved) {
      if (!(this_present_filesmoved && that_present_filesmoved))
        return false;
      if (!this.filesmoved.equals(that.filesmoved))
        return false;
    }
  ...
  public int compareTo(AuditMessage other) {
    ...
    lastComparison = Boolean.valueOf(isSetFilesmoved()).compareTo(typedOther.isSetFilesmoved());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFilesmoved()) {      lastComparison = TBaseHelper.compareTo(this.filesmoved, typedOther.filesmoved);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.filesmoved = new HashMap<String,String>(2*_map15.size);
              for (int _i16 = 0; _i16 < _map15.size; ++_i16)
              {
                ...
                this.filesmoved.put(_key17, _val18);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.received != null) {
      oprot.writeFieldBegin(RECEIVED_FIELD_DESC);
      {
        ...
        for (Map.Entry<Long, Long> _iter19 : this.received.entrySet())
        {
    ...
    if (this.sent != null) {
      oprot.writeFieldBegin(SENT_FIELD_DESC);
      {
        ...
        for (Map.Entry<Long, Long> _iter20 : this.sent.entrySet())
        {
    ...
    if (this.filenames != null) {
      oprot.writeFieldBegin(FILENAMES_FIELD_DESC);
      {
        ...
        for (String _iter21 : this.filenames)
        {
    ...
    if (this.tags != null) {
      oprot.writeFieldBegin(TAGS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, String> _iter22 : this.tags.entrySet())
        {
    ...
    if (this.filesmoved != null) {
      oprot.writeFieldBegin(FILESMOVED_FIELD_DESC);
      {
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.filesmoved.size()));
        for (Map.Entry<String, String> _iter23 : this.filesmoved.entrySet())
        {
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("filesmoved:");
    if (this.filesmoved == null) {
      sb.append("null");
    } else {
      sb.append(this.filesmoved);
    }
    first = false;
    sb.append(")");
    return sb.toString();
