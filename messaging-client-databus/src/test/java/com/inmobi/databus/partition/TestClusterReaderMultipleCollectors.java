...
public class TestClusterReaderMultipleCollectors {
  ...
  public void testReadFromStart() throws Exception {
    ...
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
        ...
        buffer, true, null, null, partitionMinList, false);
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
    ...
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
        ...
        buffer, true, fromTime, fs.getFileStatus(movedPath1), partitionMinList, false);
    fromTime = getTimeStampFromFile(movedPath2);
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
        fs.getFileStatus(movedPath3)), 3, 0, 50, partitionId,
        buffer, true, fromTime, fs.getFileStatus(movedPath2), partitionMinList, false);
    ...
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
        ...
        buffer, true, fromTime, fs.getFileStatus(movedPath3), partitionMinList, false);
    ...
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
        ...
        buffer, true, fromTime, fs.getFileStatus(movedPath4), partitionMinList, false);
    fromTime = getTimeStampFromFile(movedPath5);
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
        fs.getFileStatus(movedPath6)), 4, 0, 100, partitionId,
        buffer, true, fromTime, fs.getFileStatus(movedPath5), null, false);
    Assert.assertTrue(buffer.isEmpty());
    ...
    TestUtil.assertBuffer(DatabusStreamWaitingReader.getHadoopStreamFile(
        fs.getFileStatus(movedPath6)), 4, 0, 100, partitionId,
        buffer, true, fromTime, fs.getFileStatus(movedPath5), partitionMinList, false);
    Assert.assertTrue(buffer.isEmpty());
    preader.close();
