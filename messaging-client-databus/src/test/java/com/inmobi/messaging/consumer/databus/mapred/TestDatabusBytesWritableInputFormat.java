...
public class TestDatabusBytesWritableInputFormat extends
    TestAbstractInputFormat {

  private static final Log LOG =
      LogFactory.getLog(TestDatabusBytesWritableInputFormat.class.getName());
  DatabusBytesWritableInputFormat databusInputFormat;

  @BeforeTest
  public void setUp() throws Exception {
    databusInputFormat = new DatabusBytesWritableInputFormat();
   ...
   */
  private List<Message> readSplit(DatabusBytesWritableInputFormat format,
      InputSplit split,
   ...
   */
  @Test
  public void testDatabusBytesWritableInputFormat() throws Exception {
